...
class CreateIfrsBalancesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create(config('accounting.table_prefix').'balances', function (Blueprint $table) {
            ...
            $table->foreign('exchange_rate_id')->references('id')->on(config('accounting.table_prefix').'exchange_rates');
            $table->foreign('account_id')->references('id')->on(config('accounting.table_prefix').'accounts');
            $table->foreign('reporting_period_id')->references('id')->on(config('accounting.table_prefix').'reporting_periods');
