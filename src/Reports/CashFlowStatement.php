...
class CashFlowStatement extends FinancialStatement
{
    ...
    public function toString(): void
    {
        ...
        // Operating Cash Flow
        $statement .= PHP_EOL;
        $statement .= config('accounting')['statements'][self::OPERATIONS_CASH_FLOW] . PHP_EOL;
        ...
        // Investment Cash Flow
        $statement .= PHP_EOL;
        $statement .= config('accounting')['statements'][self::INVESTMENT_CASH_FLOW] . PHP_EOL;
        ...
        // Financing Cash Flow
        $statement .= PHP_EOL;
        $statement .= config('accounting')['statements'][self::FINANCING_CASH_FLOW] . PHP_EOL;
        ...
        // Net Cash Flow
        $statement .= PHP_EOL;
        $statement .= config('accounting')['statements'][self::NET_CASH_FLOW] . PHP_EOL;
    ...
    {
        $sectionNames = config('accounting')['statements'];
