...
use Seyls\Accounting\Reports\IncomeStatement;
...
use Seyls\Accounting\Exceptions\InvalidBalanceType;
use Seyls\Accounting\Exceptions\InvalidBalanceDate;
use Seyls\Accounting\Exceptions\InvalidBalanceTransaction;
use Seyls\Accounting\Exceptions\InvalidAccountClassBalance;
...
class Balance extends Model implements Recyclable, Clearable, Segregatable
{
    ...
    {
        return config('accounting')['balances'][$type];
    }
    ...
    public function save(array $options = []): bool
    {
        ...
        if (in_array($this->account->account_type, config('accounting.single_currency')) && $this->account->currency_id != $this->currency_id) {
